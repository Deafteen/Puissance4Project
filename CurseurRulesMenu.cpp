#include "CurseurRulesMenu.h"
#include "EngineManager.h"
#include "Puissance4.h"
#include "StateManager.h"

CurseurRulesMenu::CurseurRulesMenu(EngineManager* engineManagerP) : Curseur(engineManagerP){
...
CurseurRulesMenu::~CurseurRulesMenu(void)
{
}

void CurseurRulesMenu::compute() {
 /*   if(moveCursorLeft) {
